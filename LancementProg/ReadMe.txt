...
Changer le contenu de la variable "folder_address" par le chemin vers le fichier "ApplicationPrincipale.R".
Par exemple : "C:/ProjetM1/ProgrammePrincipal/ApplicationPrincipale.R"
	require(shiny)
  ----> folder_address = '******'
...
3- Ouvrir RunApp.txt :
Changez le chemin vers le fichier "R.exe".
Par exemple : "C:\R-4.2.3\bin\R.exe" CMD BATCH "..\R\RunApp.R"
